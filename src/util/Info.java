...
public class Info {
	...
	System.out.print(Info.getBetweenDayNumber("2012-11-11 11:19", "2012-11-11 11:11"));
	 ...
	 public static void writeExcel(String fileName,String prosstr,java.util.List<List> list,HttpServletRequest request, HttpServletResponse response){    
	        ...
	        try {
				response.sendRedirect("/jsp_qzzp_sys/upload?filename="+fileName.substring(fileName.lastIndexOf("/")+1));
			} catch (IOException e) {
				e.printStackTrace();
			}
	 ...
	 public static String getFileUpInfo()
		{
			String jscode = "";
			jscode+="<script src=/jsp_qzzp_sys/js/popup.js></script>";
	  ...
	  public static String tform(HashMap map)
		{
	    	String jscode = "<style type=\"text/css\">a{text-decoration: none;}</style> \n";
	    	try{
	...
	public static String getImgUpInfoext(int height)
	{
		...
		jscode+="<script type=\"text/javascript\"  src=\"/jsp_qzzp_sys/js/popupsext.js\"></script>";
		return jscode;
	}
	...
	public static String getImgUpInfo(int height)
	{
		...
		jscode+="<img style=\"cursor: hand\" onclick=\"uploadimg()\" src=\"/jsp_qzzp_sys/js/nopic.jpg\" id=txt height=\""+height+"\"/>";
		jscode+="<input type=hidden name=\"filename\" id=\"filename\" value=\"\" />";
		jscode+="<script type=\"text/javascript\"  src=\"/jsp_qzzp_sys/js/popups.js\"></script>";
		return jscode;
	}
	...
	public static String getImgUpInfo2(int height)
	{
		...
		jscode+="<img style=\"cursor: hand\" onclick=\"uploadimg2()\" src=\"/jsp_qzzp_sys/js/nopic.jpg\" id=txt2 height=\""+height+"\"/>";
		jscode+="<input type=hidden name=\"filename2\" id=\"filename2\" value=\"\" />";
		jscode+="<script type=\"text/javascript\"  src=\"/jsp_qzzp_sys/js/popup.js\"></script>";
		return jscode;
	}
	...
	{
		String jscode = "";
		jscode+="<img style=\"cursor: hand\" onclick=\"uploadimg5()\" src=\"/jsp_qzzp_sys/js/nopic.jpg\" id=txt5 height=\""+height+"\"/>";
	...
	public static String fck(int height,String content)
	{
		...
		jscode+="<script type=\"text/javascript\"  src=\"/jsp_qzzp_sys/fckeditor/fckeditor.js\"></script>";
