          ...
          <TD vAlign=top>
            <TABLE border=0 cellSpacing=0 cellPadding=0 width="100%">
              ...
              <TR>
                ...
                <form action="/jsp_qzzp_sys/jsp_qzzp_sys?ac=regmember" onSubmit="return check();" method="post" name="f1" enctype="multipart/form-data" >
                <TABLE 
                          ...
                          <TBODY>
                            <TR>
                              <TD class=css height=32 align=left>
                                <center>
                                <strong>
                                <% out.print(jjmap.get("tname")); %>
                                </strong>
                                <table><tr><td></td></tr></table> 
                                <%="注册时间:"+ jjmap.get("savetime") %>
                                <table><tr><td></td></tr></table>
                               
                               <img src="upfile/<%=jjmap.get("filename")%>" height="80" />
                                <table><tr><td></td></tr></table>
                                </center>
                             ...
                             <table><tr><td height="4"></td></tr></table>
                                ...
                                所需岗位 :  <% out.print(jjmap.get("email")); %>
                              
                              <table><tr><td height="4"></td></tr></table>
                              
                               城市 :  
                              <%HashMap aamm = dao.select("select * from area where id="+jjmap.get("houhold")).get(0); %>
                              <%=aamm.get("addr") %>
                              <table><tr><td height="4"></td></tr></table>
                              
                               公司地址 :  <% out.print(jjmap.get("addrs")); %>
                               ...
                               公司性质 :  <% out.print(jjmap.get("zy")); %>
                               
                               <table><tr><td height="4"></td></tr></table>
                              
                               公司规模 :  <% out.print(jjmap.get("wei")); %>
                               
                                 <table><tr><td height="4"></td></tr></table>
                              
                               行业类别 :  <% out.print(jjmap.get("xl")); %>
                               
                                 <table><tr><td height="4"></td></tr></table>
                              
                              成立日期 :  <% out.print(jjmap.get("cbdate")); %>
                               
                                 <table><tr><td height="4"></td></tr></table>
                              
                               公司简介 :  <% out.print(jjmap.get("grjs")); %>
