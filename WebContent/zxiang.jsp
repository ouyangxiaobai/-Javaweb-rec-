                  ...
                  <TBODY>
                    ...
                    <TR>
                          ...
                          <TBODY>
                            <TR>
                              <TD class=css height=32 align=left>
                                ...
                                <a href="zxiang.jsp?zpinfoid=<%=jjmap.get("id") %>&id=<%=jjmap.get("id") %>">[收藏]</a>                                
                                <%} %>
                              ...
                              <table><tr><td height="9"></td></tr></table>
                               ...
                               工作地点 :  
                         <%HashMap aamm = dao.select("select * from area where id="+jjmap.get("gzdd")).get(0);%> 
                         <%=aamm.get("addr") %>    
                              <table><tr><td height="9"></td></tr></table>
                     ...
                     <%
                       ...
                       %>
                      <input type="button" onclick="window.location.replace('zxiang.jsp?id=<%=id %>&fs=fs')" value="发送求职简历">
                      <%}} %>
