      ...
      <TABLE border=0 cellSpacing=0 cellPadding=0 width=800>
       ...
       <jsp:include page="top.jsp"></jsp:include>
          ...
          <TD vAlign=top>
            <TABLE border=0 cellSpacing=0 cellPadding=0 width="100%">
              ...
              <TR>
                ...
                <form action="/jsp_qzzp_sys/fg.jsp" onSubmit="return check();" method="post" name="f1"   >
                <TABLE 
        ...
        <%} %>
                           ...
                           &nbsp;
                            ...
                            <table><tr><td></td></tr></table>
                             &nbsp;&nbsp;&nbsp;&nbsp;
                             工资待遇 : <input type=text name="gzdy" id="gzdy" size="10" style="height: 15px" />
                            &nbsp;
                            职位名称 : <input type=text name="zwmc" id="zwmc" size="10" style="height: 15px" /> 
                           &nbsp; 
        ...
        String sql =   "select * from zpinfo where 1=1 ";  
         ...
         if (!uname.equals("")) sql+=" and qyuname like'%"+uname+"%' ";
         if (!tname.equals("")) sql+=" and qytname like'%"+tname+"%' ";
         if (!gzdd.equals("")) sql+=" and gzdd like'%"+gzdd+"%' ";  
         if (!xlyq.equals("")) sql+=" and xl like'%"+xlyq+"%' ";  
         if (!gzdy.equals("")) sql+=" and dy like'%"+gzdy+"%' ";  
         if (!zwmc.equals("")) sql+=" and title like'%"+zwmc+"%' ";  
