...
%>
<body>
<form  action="xwhbnewsxg.jsp?f=f&id=<%=mmm.get("id")%>"  name="f1" method="post" onSubmit="return checkform()">
...
<tr>
  ...
  <tr>
    <td><table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#a8c7ce"  class="mytab" onMouseOver="changeto()"  onmouseout="changeback()">
      <tr>
        <td width="17%" height="30" align="center" bgcolor="#FFFFFF" class="STYLE19">标题</td>
        <td width="83%" height="30" align="left" bgcolor="#FFFFFF" class="STYLE19">&nbsp;<input type=text  onblur='checkform()'  class='' id='title' name='title' size=55 /><label id='clabeltitle' /></td>
        </tr>
<tr>
        <td width="17%" height="30" align="center" bgcolor="#FFFFFF" class="STYLE19">作者</td>
        <td width="83%" height="30" align="left" bgcolor="#FFFFFF" class="STYLE19">&nbsp;<input type=text  onblur='checkform()'  class='' id='author' name='author' size=35 /><label id='clabelauthor' /></td>
        </tr>
<tr>
        <td width="17%" height="30" align="center" bgcolor="#FFFFFF" class="STYLE19">相关图片</td>
        <td width="83%" height="30" align="left" bgcolor="#FFFFFF" class="STYLE19">&nbsp;<%=Info.getImgUpInfo(65)%></td>
        </tr>
<tr>
        <td width="17%" height="30" align="center" bgcolor="#FFFFFF" class="STYLE19">内容</td>
        <td width="83%" height="30" align="left" bgcolor="#FFFFFF" class="STYLE19"><%=Info.fck(265,mmm.get("content").toString())%></td>
        </tr>
	   ...
	   <tr>
        <td height="30" colspan="2" align="center" bgcolor="#FFFFFF" class=""><label>
          ...
          &nbsp;&nbsp;&nbsp;
          <input type=button value='返回上页' onclick='window.location.replace("xwhbnewscx.jsp")' />
</label></td>
        </tr>
    </table></td>
  </tr>
