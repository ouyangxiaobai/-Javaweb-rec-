...
<% 
new CommDAO().delete(request,"area"); 
String id = request.getParameter("id"); 
HashMap ext = new HashMap(); 
new CommDAO().update(request,response,"area ",ext,true,false); 
HashMap mmm = new CommDAO().getmap(id,"area"); 
%>
<body>
<form  action="areaedit.jsp?f=f&id=<%=mmm.get("id")%>"  name="f1" method="post" onSubmit="return checkform()">
