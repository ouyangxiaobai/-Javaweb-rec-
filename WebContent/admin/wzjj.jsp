...
ext.put("datatype","系统简介"); 
new CommDAO().update(request,response,"zdatadic",ext,true,false); 
HashMap mmm = new CommDAO().getmap(id,"zdatadic"); 
%>
<body>
<form  action="wzjj.jsp?f=f&id=<%=mmm.get("id")%>"  name="f1" method="post" onSubmit="return checkform()">
          ...
          <tr>
            <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
              <tr>
                ...
                <td width="97%" valign="bottom"><span class="STYLE1"> 系统简介&nbsp;&nbsp;</span></td>
              </tr>
            </table></td>
            <td> 
