...
%>
<body>
<form  action="xwhbnewstj.jsp?f=f&tglparentid=<%=tglparentid%>"  name="f1" method="post" onSubmit="return checkform()">
...
<tr>
        ...
        <td width="83%" height="30" align="left" bgcolor="#FFFFFF" class="STYLE19"><%=Info.fck(265,"")%></td>
        </tr>
