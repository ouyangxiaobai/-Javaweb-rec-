...
<body>
<form  action="rctj.jsp"  name="f1" method="post">
...
<td height="30" align="center"  style="background-color: #F3F8F7;color:#344B50;"  >电话</td>
<td height="30" align="center"  style="background-color: #F3F8F7;color:#344B50;"  >专业</td>
<td height="30" align="center"  style="background-color: #F3F8F7;color:#344B50;"  >学历</td>
<td height="30" align="center"  style="background-color: #F3F8F7;color:#344B50;"  >毕业学校</td>

<td height="30" align="center"  style="background-color: #F3F8F7;color:#344B50;"  >意向行业</td>
<td height="30" align="center"  style="background-color: #F3F8F7;color:#344B50;"  >操作</td>
      ...
      HashMap abc = new CommDAO().select("select * from sysuser where id="+user.get("id")).get(0);
...
String sql = "select * from sysuser where 1=1 " ;
 ...
 if(!houhold.equals("")){  
 mmm.put("houhold",houhold) ;
 sql+= " and houhold ='"+houhold+"' " ;
 }  
  sql +="  and (1=1 " ; 
  sql +="  or  utype like'%求职者%' " ;
  sql +="  ) ";
  sql +=" and qzyx = '"+abc.get("xl")+"'";
  sql +=" order by id desc ";
  System.out.println(sql);
String url = "rctj.jsp?1=1&uname="+puname+"&tname="+ptname+"&houhold="+phouhold+"&zy="+pzy+""; 
ArrayList<HashMap> list = PageManager.getPages(url,5, sql, request ); 
for(HashMap map:list){ %>
<tr>

        <td height="30" align="center" bgcolor="#FFFFFF" class="STYLE19"><%=map.get("tname")%></td>
        <td height="30" align="center" bgcolor="#FFFFFF" class="STYLE19"><%=map.get("tel")%></td>
        <td height="30" align="center" bgcolor="#FFFFFF" class="STYLE19"><%=map.get("zy")%></td>
        <td height="30" align="center" bgcolor="#FFFFFF" class="STYLE19"><%=map.get("xl")%></td>
        <td height="30" align="center" bgcolor="#FFFFFF" class="STYLE19"><%=map.get("school")%></td>
        <td height="30" align="center" bgcolor="#FFFFFF" class="STYLE19"><%=map.get("qzyx")%></td>
        <td height="30" align="center" bgcolor="#FFFFFF" class="STYLE19">
<a href="/jsp_qzzp_sys/bxiang.jsp?g=g&id=<%=map.get("id") %>" target="_blank">查看简历</a>
</td>
</tr>
<%}%>
