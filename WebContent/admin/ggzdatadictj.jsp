...
ext.put("datatype","职场资讯"); 
new CommDAO().insert(request,response,"zdatadic",ext,true,false); 
%>
<body>
<form  action="ggzdatadictj.jsp?f=f&tglparentid=<%=tglparentid%>"  name="f1" method="post" onSubmit="return checkform()">
  ...
  <tr>
    <td><table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#a8c7ce"  class="mytab" onMouseOver="changeto()"  onmouseout="changeback()">
      <tr>
        ...
        <td width="83%" height="30" align="left" bgcolor="#FFFFFF" class="STYLE19">&nbsp;<input type=text  onblur='checkform()' class='' id='ptitle' name='ptitle' size=55 /><label id='clabelptitle' /></td>
        </tr>
<tr>
	   ...
	   <tr>
        <td height="30" colspan="2" align="center" bgcolor="#FFFFFF" class=""><label>
          ...
          &nbsp;&nbsp;&nbsp;
          <input type=button value='返回上页' onclick='window.location.replace("wzgg.jsp")' />
</label></td>
        </tr>
    </table></td>
  </tr>
...
if(ptitleobj.value==""){  
document.getElementById("clabelptitle").innerHTML="&nbsp;&nbsp;<font color=red>请输入标题</font>";  
return false;  
}else{
