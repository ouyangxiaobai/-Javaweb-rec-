...
String qzzuname=request.getParameter("qzzuname")==null?"":request.getParameter("qzzuname"); 
System.out.println("qzzuname=="+qzzuname);
String content=request.getParameter("content")==null?"":request.getParameter("content"); 
ext.put("content",content); 
ext.put("qzzuname",qzzuname); 
ext.put("qyid",user.get("id")); 
ext.put("savetime",Info.getDateStr()); 
new CommDAO().insert(request,response,"msg ",ext,true,false); 
%>
<body>
<form  action="msgadd.jsp?f=f&qzzuname=<%=qzzuname %>"  name="f1" method="post" onSubmit="return checkform()">
          ...
          <tr>
            <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
              <tr>
                ...
                <td width="97%" valign="bottom"><span class="STYLE1"> 发送信件&nbsp;&nbsp;</span></td>
              </tr>
            </table></td>
            <td> 
  ...
  <tr>
    <td><table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#a8c7ce"  class="mytab" onMouseOver="changeto()"  onmouseout="changeback()">
      <tr>
        ...
        <textarea rows="5" cols="50" onblur='checkform()' id='content' name='content'></textarea>
        <label id='clabelcontent' /></td>
        </tr>
	   <tr>
...
if(contentobj.value==""){  
document.getElementById("clabelcontent").innerHTML="&nbsp;&nbsp;<font color=red>请输入内容</font>";  
return false;  
}else{
document.getElementById("clabelcontent").innerHTML="  ";  
}  
