...
<body>
<form  action="xwhbnewscx.jsp"  name="f1" method="post">
          ...
          <tr>
            <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
              <tr>
                ...
                <td width="97%" valign="bottom"><span class="STYLE1"> 求职技巧</span></td>
              </tr>
            </table></td>
            <td> 
...
<input type=submit class='' value='查询信息' />
 &nbsp;&nbsp;
<input type=button   class='' value='添加信息' onclick="window.location.replace('xwhbnewstj.jsp')" /> 
&nbsp;&nbsp;</td>
        </tr>
...
String url = "xwhbnewscx.jsp?1=1&title="+ptitle+"&author="+pauthor+""; 
...
<a href="xwhbnewsxg.jsp?id=<%=map.get("id")%>">修改</a>
&nbsp;&nbsp;|&nbsp;&nbsp;&nbsp;

<a onclick="return confirm('确定要删除这条记录吗?')" href="xwhbnewscx.jsp?scid=<%=map.get("id")%>">删除</a>
</td>
</tr>
<%}%>
...
<script language=javascript> 
function update(no){ 
pop('xwhbnewsxg.jsp?id='+no,'信息修改',550,'100%') 
}
</script> 
<script language=javascript> 
function add(){ 
pop('xwhbnewstj.jsp','信息添加',550,'100%') 
}
</script> 
<%@page import="util.Info"%> 
