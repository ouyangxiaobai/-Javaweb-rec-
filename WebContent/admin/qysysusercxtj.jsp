...
<a href="/jsp_qzzp_sys/fg.jsp?g=g&uname=<%=map.get("uname") %>" target="_blank">查看招聘信息</a>
&nbsp;|&nbsp;&nbsp;

<a href="/jsp_qzzp_sys/qxiang.jsp?id=<%=map.get("id") %>" target="_blank">查看企业信息</a>
</td>
</tr>
<%}%>
