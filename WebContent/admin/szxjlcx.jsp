...
.mytab {
	...
	border:#DBE6E3 solid 0px; border-bottom:0; border-right:0; border-left:#DBE6E3 solid 1px;
	line-height:175%; 
	margin:1px 1px;
	margin-left: 0px;	
}
...
<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
  ...
  <tr>
    <td>
     ...
     <div style="height:244px ;overflow:auto" align="left" >
    <table width="100%" border="0" cellpadding="0" cellspacing="1" class="mytab"   onmouseover="changeto()"  onmouseout="changeback()">
...
pop('zxjltj.jsp','信息添加',550,'100%') 
      ...
      {
        var ajax = new AJAX();
        ajax.post("/jsp_qzzp_sys/factory/getsonops.jsp?ctype=tchat&id=<%=id%>&touname=<%=new CommDAO().getmap(id,"zxjl").get("touname")%>&tname=<%=tname%>&tcontent="+document.getElementById("tcontent").value);
      ...
      var tk = "";
        var ajax = new AJAX();
        ajax.post("/jsp_qzzp_sys/factory/getsonops.jsp?ctype=chat&id=<%=id%>&tname=<%=tname%>");
