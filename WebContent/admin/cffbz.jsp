...
<body>
<form  action="cffbz.jsp"  name="f1" method="post">
...
&nbsp; 
补缴月份 :   
<input type=text class='' onclick="WdatePicker({dateFmt:'yyyy-MM'});"  size=6 name='startjfmonth' />
&nbsp;&nbsp;至&nbsp;&nbsp;
<input type=text class='' onclick="WdatePicker({dateFmt:'yyyy-MM'});"  size=6 name='endjfmonth' />
&nbsp;
...
String sql = "select uname,tname,houhold,addrs,jfmonth,sum(jfje) jfje from charges where uname='"+uname+"' " ;
    
  
 if(!startjfmonth.equals("")){ 
 sql+= " and jfmonth >='"+startjfmonth+"-01' " ;
 }   
 
  if(!endjfmonth.equals("")){ 
 sql+= " and jfmonth <='"+endjfmonth+"-31' " ;
 }   
 
  sql +=" group by uname,tname,houhold,addrs,jfmonth ";
String url = "cffbz.jsp?1=1&uname="+puname+"&tname="+ptname+"&houhold="+phouhold+"&addrs="+paddrs+"&jfmonth="+pjfmonth+""; 
...
<tr>
        ...
        <td height="30" align="center" bgcolor="#FFFFFF" class="STYLE19"><%=map.get("houhold")%></td>
        <td height="30" align="center" bgcolor="#FFFFFF" class="STYLE19"><%=map.get("addrs")%></td>
        <td height="30" align="center" bgcolor="#FFFFFF" class="STYLE19"><%=map.get("jfmonth")%></td>
        <td height="30" align="center" bgcolor="#FFFFFF" class="STYLE19"><%=map.get("jfje")%></td>
        <td height="30" align="center" bgcolor="#FFFFFF" class="STYLE19"><%=fmonth%></td>
        <td height="30" align="center" bgcolor="#FFFFFF" class="STYLE19"><%=je%></td>
...
mmm.put("endjfmonth",endjfmonth); 
mmm.put("startjfmonth",startjfmonth); 
%>
<%=Info.tform(mmm)%> 
