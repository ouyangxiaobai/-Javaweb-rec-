...
%>
<body>
<form  action="yqljtj.jsp?f=f&tglparentid=<%=tglparentid%>"  name="f1" method="post" onSubmit="return checkform()">
...
<script language=javascripjsp_qzzp_sys/lyshand/js/My97DatePicker/WdatePicker.js'></script>
<script language=javascrijsp_qzzp_sys'/lyshand/js/popup.js'></script>
<script language=javascrjsp_qzzp_sys='/lyshand/js/ajax.js'></script>
...
var ljnameobj = document.getElementById("ljname");  
if(ljnameobj.value!=""){  
var ajsp_qzzp_sysew AJAX();
ajax.post("/lyshand/factory/checkno.jsp?table=yqlj&col=ljname&value="+ljnameobj.value+"&checktype=insert&ttime=<%=Info.getDateStr()%>") 
