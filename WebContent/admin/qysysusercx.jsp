...
<body>
<form  action="qysysusercx.jsp"  name="f1" method="post">
          ...
          <tr>
            <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
              <tr>
                ...
                <td width="97%" valign="bottom"><span class="STYLE1"> 企业信息管理</span></td>
              </tr>
            </table></td>
            <td> 
...
<td height="30" align="center"  style="background-color: #F3F8F7;color:#344B50;"  >需求岗位</td>
...
String url = "qysysusercx.jsp?1=1&uname="+puname+"&tname="+ptname+"&houhold="+phouhold+"&zy="+pzy+""; 
...
<tr>
        ...
        <%HashMap aamm = new CommDAO().select("select * from area where id="+map.get("houhold")).get(0);%> 
                         <%=aamm.get("addr") %>  
        </td>
        ...
        <td height="30" align="center" bgcolor="#FFFFFF" class="STYLE19">
<a href="qysysuserxg.jsp?id=<%=map.get("id")%>">查看</a>
&nbsp;&nbsp;|&nbsp;&nbsp;&nbsp;

<a onclick="return confirm('确定要删除这条记录吗?')" href="qysysusercx.jsp?scid=<%=map.get("id")%>">删除</a>
</td>
</tr>
<%}%>
...
<script language=javascript> 
function update(no){ 
pop('qysysuserxg.jsp?id='+no,'信息修改',550,'100%') 
}
</script> 
<script language=javascript> 
function add(){ 
