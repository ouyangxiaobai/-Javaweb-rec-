...
HashMap mmm = new CommDAO().select("select * from sysuser where uname='"+puname+"'").get(0); 
%>
<body>
<form  action="ckjl.jsp?f=f&id=<%=mmm.get("id")%>"  name="f1" method="post" onSubmit="return checkform()">
          ...
          <tr>
            <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
              <tr>
                ...
                <td width="97%" valign="bottom"><span class="STYLE1"> 简历查看&nbsp;&nbsp;</span></td>
              </tr>
            </table></td>
            <td> 
...
<tr>
        ...
        <td width="83%" height="30" align="left" bgcolor="#FFFFFF" class="STYLE19">&nbsp;<%=mmm.get("sex")%></td>
        </tr>
<tr>
        <td width="17%" height="30" align="center" bgcolor="#FFFFFF" class="STYLE19">联系QQ</td>
        <td width="83%" height="30" align="left" bgcolor="#FFFFFF" class="STYLE19">&nbsp;<%=mmm.get("qq")%></td>
        </tr>
<tr>
...
<tr>
        ...
        <td width="83%" height="30" align="left" bgcolor="#FFFFFF" class="STYLE19">&nbsp;<%=mmm.get("hei")%></td>
        </tr>
<tr>
        <td width="17%" height="30" align="center" bgcolor="#FFFFFF" class="STYLE19">健康状态</td>
        <td width="83%" height="30" align="left" bgcolor="#FFFFFF" class="STYLE19">&nbsp;<%=mmm.get("health")%></td>
        </tr>
<tr>
...
<tr>
        ...
        <td width="83%" height="30" align="left" bgcolor="#FFFFFF" class="STYLE19">&nbsp;<%=mmm.get("school")%></td>
        </tr>
<tr>
...
<tr>
        ...
        <td width="83%" height="30" align="left" bgcolor="#FFFFFF" class="STYLE19">&nbsp;<%=mmm.get("xqah")%></td>
        </tr>
<tr>
        <td width="17%" height="30" align="center" bgcolor="#FFFFFF" class="STYLE19">工作经历</td>
        <td width="83%" height="30" align="left" bgcolor="#FFFFFF" class="STYLE19">&nbsp;<%=mmm.get("gzjl")%></td>
        </tr>
<tr>
        <td width="17%" height="30" align="center" bgcolor="#FFFFFF" class="STYLE19">项目经验</td>
        <td width="83%" height="30" align="left" bgcolor="#FFFFFF" class="STYLE19">&nbsp;<%=mmm.get("xmjy")%></td>
        </tr>
<tr>
        <td width="17%" height="30" align="center" bgcolor="#FFFFFF" class="STYLE19">外语能力</td>
        <td width="83%" height="30" align="left" bgcolor="#FFFFFF" class="STYLE19">&nbsp;<%=mmm.get("wyll")%></td>
        </tr>
...
<tr>
	   ...
	   <tr>
        <td height="30" colspan="2" align="center" bgcolor="#FFFFFF" class=""><label>
          ...
          <input type=button value='返回上页' onclick='window.location.replace("empcx.jsp")' />
</label></td>
        </tr>
    </table></td>
  </tr>
