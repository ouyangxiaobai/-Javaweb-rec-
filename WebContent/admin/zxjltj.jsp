...
new CommDAO().insert(request,response,"zxjl",ext,true,true); 
%>
<body>
<form  action="zxjltj.jsp?f=f&tglparentid=<%=tglparentid%>"  name="f1" method="post" onSubmit="return checkform()">
...
<tr>
          ...
          <tr>
            <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
              <tr>
                ...
                <td width="97%" valign="bottom"><span class="STYLE1"> 发送信息&nbsp;&nbsp;</span></td>
              </tr>
            </table></td>
            <td> 
  ...
  <tr>
    <td><table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#a8c7ce"  class="mytab" onMouseOver="changeto()"  onmouseout="changeback()">
      <tr>
        <td width="21%" height="30" align="center" bgcolor="#FFFFFF" class="STYLE19">接受方</td>
        <%
        if(utype.equals("求职者")){
         %>
        <td width="79%" height="30" align="left" bgcolor="#FFFFFF" class="STYLE19">&nbsp;<%=Info.getselect("touname","sysuser","tname~无名","utype='企业'")%> 
<label id='clabeltouname' />
</td>
<%}else{ %>
  <td width="79%" height="30" align="left" bgcolor="#FFFFFF" class="STYLE19">&nbsp;<%=Info.getselect("touname","sysuser","tname~无名","utype='求职者'")%> 
<label id='clabeltouname' />
</td>
<%} %>
        </tr>
<tr>
        <td width="21%" height="30" align="center" bgcolor="#FFFFFF" class="STYLE19">内容</td>
        <td width="79%" height="30" align="left" bgcolor="#FFFFFF" class="STYLE19">&nbsp;<textarea  cols='35'  style='margin-top: 1px;margin-bottom: 1px'  class=''  name='tcontent'  ></textarea></td>
        </tr>
...
if(tounameobj.value==""){  
document.getElementById("clabeltouname").innerHTML="&nbsp;&nbsp;<font color=red>请输入接受方</font>";  
return false;  
}else{
