...
<input type=submit class='' value='查询信息' />
 &nbsp;&nbsp;
<input type=button   class=''  value='发起会话' onclick="update('');" /> &nbsp;&nbsp;</td>
        </tr>
...
<tr>
        ...
        <td height="30" align="center" bgcolor="#FFFFFF" class="STYLE19"><%=map.get("tcontent")%></td>
...
<script language=javascript> 
function add(no){ 
pop('szxjlcx.jsp?id='+no,'会话',550,314) 
}
</script> 
<%@page import="util.Info"%> 
