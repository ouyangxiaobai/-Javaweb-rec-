...
<body>
<form  action="mymsg.jsp"  name="f1" method="post">
<table width="99.8%" border="0" align="center" cellpadding="0" cellspacing="0">
          ...
          <tr>
            <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
              <tr>
                ...
                <td width="97%" valign="bottom"><span class="STYLE1"> 企业来信</span></td>
              </tr>
            </table></td>
            <td> 
  ...
  <tr>
    <td><table width="100%" border="0" cellpadding="0" cellspacing="1" class="mytab"   onmouseover="changeto()"  onmouseout="changeback()">
      ...
      <tr bgcolor="#F3F8F7">
        <td height="30" align="center"  style="background-color: #F3F8F7;color:#344B50;"  >来信内容</td>
        <td height="30" align="center"  style="background-color: #F3F8F7;color:#344B50;"  >来信企业</td>
        <td height="30" align="center"  style="background-color: #F3F8F7;color:#344B50;"  >时间</td>
...
if(request.getParameter("did")!=null){ 
 new CommDAO().commOper("delete from msg where id="+request.getParameter("did"));  
} 

String sql = "select * from msg where qzzuname='"+user.get("uname")+"' " ;


  sql +=" order by id desc ";
String url = "mymsg.jsp?1=1"; 
...
<tr>
        ...
        <td height="30" align="center" bgcolor="#FFFFFF" class="STYLE19">
        	<%HashMap qymap = new CommDAO().select("select * from sysuser where id="+map.get("qyid")).get(0); %>
        	<%=qymap.get("tname") %>
        </td>
        <td height="30" align="center" bgcolor="#FFFFFF" class="STYLE19"><%=map.get("savetime")%></td>
        <td height="30" align="center" bgcolor="#FFFFFF" class="STYLE19">
        <a href="/jsp_qzzp_sys/qxiang.jsp?id=<%=qymap.get("id")%>" target="_blank">查看企业</a>
&nbsp;|&nbsp;
<a onclick="return confirm('确定要删除这条记录吗?')" href="mymsg.jsp?did=<%=map.get("id")%>">删除</a>
</td>
</tr>
<%}%>
