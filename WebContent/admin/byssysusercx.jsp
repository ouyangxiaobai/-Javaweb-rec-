          ...
          <tr>
            <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
              <tr>
                ...
                <td width="97%" valign="bottom"><span class="STYLE1"> 求职者信息管理</span></td>
              </tr>
            </table></td>
            <td> 
...
<tr>
        ...
        <td height="30" align="center" bgcolor="#FFFFFF" class="STYLE19"><%=map.get("birth")%></td>
        <td height="30" align="center" bgcolor="#FFFFFF" class="STYLE19">
