...
function uploadimg()
{
pop("/jsp_qzzp_sys/js/uploadimg.jsp","上传图片",300,77)
}


function uploadimg2()
{
pop("/jsp_qzzp_sys/js/uploadimg2.jsp","上传图片",300,77)
}

function uploadimg3()
{
pop("/jsp_qzzp_sys/js/uploadimg3.jsp","上传图片",300,77)
}

function uploadimg4()
{
pop("/jsp_qzzp_sys/js/uploadimg4.jsp","上传图片",300,77)
}


function uploadimg5()
{
pop("/jsp_qzzp_sys/js/uploadimg5.jsp","上传图片",300,77)
}


function uploaddoc()
{
pop("/jsp_qzzp_sys/js/uploaddoc.jsp","docupload",300,77)
}
...
build:function(){
   ...
   var close='<img id="dialogBoxClose" title="关闭" src=/jsp_qzzp_sys/js/dialogclose.gif  />';
